    ...
    <div class="well">
        ...
        echo Form::widget([
            ...
            'attributes' => [
                ...
                'remain' => ['type' => Form::INPUT_TEXT, 'label' => '次数', 'options' => ['disabled' => true, 'value' => $model->userBusiness == null ? 0 : $model->userBusiness->remain]],
                'level' => ['type' => Form::INPUT_DROPDOWN_LIST, 'items' => \common\models\c2\statics\UserLevel::getHashMap('id', 'label')],
