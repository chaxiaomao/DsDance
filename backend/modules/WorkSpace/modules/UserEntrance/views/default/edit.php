...
use backend\modules\WorkSpace\modules\UserEntrance\widgets\EntityDetail;

/* @var $this yii\web\View */
/* @var $model common\models\c2\entity\UserEntranceModel */

if($model->isNewRecord){
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Create'), 'modelClass' => Yii::t('app.c2', 'User Entrance Model'),]);
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'User Entrance Models'), 'url' => ['index']];
$this->params['breadcrumbs'][] = $this->title;
}
else{
$this->title = Yii::t('app.c2', '{actionTips} {modelClass}: ', ['actionTips' => Yii::t('app.c2', 'Update'), 'modelClass' => Yii::t('app.c2', 'User Entrance Model'),]) . ' ' . $model->id;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app.c2', 'User Entrance Models'), 'url' => ['index']];
